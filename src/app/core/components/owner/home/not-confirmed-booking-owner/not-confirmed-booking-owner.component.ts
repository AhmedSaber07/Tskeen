...
@Component({
  selector: 'app-not-confirmed-booking-owner',
  standalone: true,
  imports: [],
  templateUrl: './not-confirmed-booking-owner.component.html',
  styleUrl: './not-confirmed-booking-owner.component.css'
})
export class NotConfirmedBookingOwnerComponent {
